...
- **페이지 로딩 시간 개선** (Chrome DevTools 기준)
    ...
    |------------|----------|----------|--------|
    | 이미지 중심 포스트 | 3-5초 | 1-2초 | 40-50% |
    | 일반 포스트 | 2-3초 | 1-1.5초 | 30-40% |
    | 메인 페이지 | 4-6초 | 2-3초 | 40-50% |
...
| 항목 | 최적화 전 | 최적화 후 | 개선율 |
|------|----------|----------|--------|
| 이미지 용량 | 88MB | 52MB | 41% 감소 |
| 페이지 로딩 시간 | 3-5초 | 1.5-2.5초 | 40-50% 단축 |
| Lighthouse 점수 | 65-70점 | 80-85점 | 15-20점 향상 |
| LCP | 3.2초 | 2.0초 | 37% 개선 |
| CLS | 0.15 | 0.08 | 47% 개선 |
| FID | 180ms | 110ms | 39% 개선 |
