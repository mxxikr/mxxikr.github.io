...
- Hibernate ddl-auto
  - **용도**
    - 로컬 개발, 프로토타이핑용
  - **위험성**
    - **절대 운영 환경(Prod)에서 쓰면 안 됨**
    - 데이터가 날아가거나, 의도치 않게 컬럼이 바뀔 수 있으며 변경 이력이 남지 않음
- Flyway
  - **용도**
    - 개발, 테스트, 운영(Prod) 모든 환경
  - **안전성**
    - 변경 이력이 철저히 남고, 실패 시 애플리케이션 구동을 멈춰서 사고를 방지함
...
- 이유
  ...
  - 대부분의 국내 서비스 기업(카카오, 토스 등)은 Flyway를 선호함
